...
<body>
                                            ...
                                            <ul class="sub-mega-item">
                                                <li style="margin: 10px 10px;">
                                                    <a class="menu-image" href="product.html">
                                                        <img src="images/coming-bg.jpg" alt="Menu">
                                                    </a>
                                                </li>
    
                                                <li style="margin: 10px 10px;">
                                                    <a class="menu-image" href="shop-sidebar.html">
                                                        <img src="images/blog-3.jpg" alt="Menu">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
    ...
    <section class="page-banner bg_cover" style="background-image: url('img/bg-main-1 (2).jpg');">
        <div class="container">
            <div class="page-banner-content text-center mt-70">
                ...
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item"><a href="product.html">Fabric</a></li>
    ...
    $fabric_type = $_GET['cat'];
    $fabric = $_GET['fabric'];
    $select_query = "SELECT * FROM $fabric WHERE fabric_type = '$fabric_type'";
...
$img = "";
    for($i=0; $i<count($img_path); $i++)
    {
        ...
        echo '<div class="product-col-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
                    <div class="single-product mt-50">
                        ...
                        <div class="product-content d-flex justify-content-between">
                            <div class="product-title">
                                <h4 class="title"><a href="product-simple-01.html">'.$data['fabric_name'].'</a></h4>
                            </div>
    ...
    <footer class="footer-area pt-50 pb-55">
        <div class="footer-widget">
            <div class="container footer-container">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="footer-logo-copyright logo-1 mt-30">
                            <a href="index.html">
...
<!-- Mirrored from live.hasthemes.com/html/13/zyra-preview/zyra/shop-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jul 2020 20:20:41 GMT -->
