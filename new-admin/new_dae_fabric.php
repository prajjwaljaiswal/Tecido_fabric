                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <div id="select_menu" class="form-group " style="margin-bottom: 0;">
                                                                <select class="custom-select type" name="type" required>
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control fabric_name" name="fabric_name" id="exampleFormControlInput2" placeholder="Georgette" required>
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Weave</label>
                                                            <input type="text" class="form-control weave" name="weave" id="exampleFormControlInput2" placeholder="Plain" required>
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Width</label>
                                                            <input type="text" class="form-control width" name="width" id="exampleFormControlInput2" placeholder="50 Inches">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Content</label>
                                                            <input type="text" class="form-control content" name="content" id="exampleFormControlInput2" placeholder="100% Viscose">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
