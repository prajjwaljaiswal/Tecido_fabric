                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><span>Velvet Fabric </span></li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-one desk_flex" >
                                ...
                                <div class="inv-action">
                                    <a href="new_vel_fabric.php" class="btn btn-danger">Add New fabric</a>
                                </div> 
                        </div>
                    </div>
                                ...
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                         <?php
                                            ...
                                            $query = $db->prepare("SELECT * FROM vel_fabric");
                                            $query->execute();
