...
session_start();
$ses_design_no = $_POST['design_no'];
$type = mysqli_real_escape_string($db,"Embrodiary Products");
    ...
    if(!file_exists("uploadFiles/".$type."/".$fabric_name."/".$design_no))
{
    ...
    $update_query = "UPDATE emb_fabric SET fabric_type = '$type', fabric_name = '$fabric_name', weave = '$weave', width = '$width', content = '$content', design_no = '$design_no', desgin_name_color = '$design_name_color', weight_feel = '$weight_feel',description = '$description', full_description = '$full_description', price = '$price' WHERE design_no = '$ses_design_no'";
