...
$type = mysqli_real_escape_string($db,"Emported_Fabric");
    ...
    if(!file_exists("uploadFiles/".$type."/".$fabric_name."/".$design_no))
{
    ...
    $insert_data = "INSERT INTO imp_fabric(fabric_type,fabric_name,weave,width,content,design_no,desgin_name_color,weight_feel,price,description,full_description)VALUES('$type','$fabric_name','$weave','$width','$content','$design_no','$design_name_color','$weight_feel','$price','$description','$full_description')";
