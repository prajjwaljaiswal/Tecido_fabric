    ...
    if(!file_exists("uploadFiles/".$type."/".$fabric_name."/".$design_no))
{
    ...
    $update_query = "UPDATE imp_fabric SET fabric_type = '$type', fabric_name = '$fabric_name', weave = '$weave', width = '$width', content = '$content', design_no = '$design_no', desgin_name_color = '$design_name_color', weight_feel = '$weight_feel', price = '$price' WHERE design_no = '$ses_design_no'";
