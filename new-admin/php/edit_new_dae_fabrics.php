...
<head>
    ...
    <meta id="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Dayeble Fabric </a></li>
                                    ...
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h4>add new Dayeble Fabric</h4>
                                            </div>                 
                                        </div>
                                    </div>
                                    <div class="widget-content widget-content-area">
                                        <form id="update_dae_fabrics">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Select type</label>
                                                            <div id="select_menu" class="form-group " style="margin-bottom: 0;">
                                                                <select class="custom-select type" name="type" value="'.$fabrics_type.'" required>
                                                                  <option value="">Select sub type of dayeble fabric</option>
                                                                  <option>Nylon</option>
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control fabric_name" name="fabric_name" id="exampleFormControlInput2" placeholder="Georgette" value="'.$fabric_name.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Weave</label>
                                                            <input type="text" class="form-control weave" name="weave" id="exampleFormControlInput2" placeholder="Plain" value="'.$weave.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Width</label>
                                                            <input type="text" class="form-control width" name="width" id="exampleFormControlInput2" placeholder="50 Inches" value="'.$width.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Content</label>
                                                            <input type="text" class="form-control content" name="content" id="exampleFormControlInput2" placeholder="100% Viscose" value="'.$content.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Design No</label>
                                                            <input type="text" class="form-control design_no" name="design_no" id="exampleFormControlInput2" placeholder="4329320" value="'.$design_no.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Design Name/Color</label>
                                                            <input type="text" class="form-control design_name_color" name="design_name_color" id="exampleFormControlInput2" placeholder="Peach" value="'.$color.'">
                                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class=" mb-2">
                                                        ...
                                                        <input type="number" class="form-control price" name="price" id="exampleFormControlInput2" placeholder="1470 per meter" value="'.$price.'">
                                                    </div>
                                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                                        ...
                                                        <label class="custom-file-container__custom-file" >
                                                            <input type="file" name="upload[]" class="custom-file-container__custom-file__custom-file-input" id="files" multiple>
                                                            <input type="hidden" id="MAX_FILE_SIZE" value="10485760" />
                                                ...
                                                <div class="col-md-12 " style="text-align: center;">
                                                    <button class="btn btn-danger new-btn" type="submit" >Update new Fabric</button>
