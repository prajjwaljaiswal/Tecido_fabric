    ...
    if(!file_exists("uploadFiles/".$type."/".$fabric_name."/".$design_no))
{
    ...
    $update_query = "UPDATE dayeble_fabric SET fabric_type = '$type', fabric_name = '$fabric_name', weave = '$weave', width = '$width', content = '$content', design_no = '$design_no', design_name_color = '$design_name_color', weight_feel = '$weight_feel', price = '$price', description = '$description' , full_description = '$full_description' WHERE design_no = '$ses_design_no'";
