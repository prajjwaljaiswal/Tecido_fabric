                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Velvet Fabric </a></li>
                                    ...
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h4>add new Velvet Fabric</h4>
                                            </div>                 
                                        </div>
                                    </div>
                                    <div class="widget-content widget-content-area">
                                        <form id="update_vel_fabrics">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-row">
...
$("#update_vel_fabrics").submit(function(e){
    e.preventDefault();  
    ...
    if(banner.files.length == 0 || banner.files.length > 4)
    {
     ...
     $.ajax({
                    ...
                    success : function(response){
                        ...
                        alert(response);
                        window.loaction.href= "http://localhost/Tecido/new-admin/vel_fabric.php";
                    }
