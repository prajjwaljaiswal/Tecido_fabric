                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Imported Fabric </a></li>
                                    ...
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h4>add new Imported Fabric</h4>
                                            </div>                 
                                        </div>
                                    </div>
                                    <div class="widget-content widget-content-area">
                                        <form id="update_imp_fabrics">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Fabric name</label>
                                                            <input type="text" class="form-control" name="fabric_name" id="exampleFormControlInput2" placeholder="Georgette" value="'.$fabric_name.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Weave</label>
                                                            <input type="text" class="form-control" name="weave" id="exampleFormControlInput2" placeholder="Plain" value="'.$weave.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Width</label>
                                                            <input type="text" class="form-control" name="width" id="exampleFormControlInput2" placeholder="50 Inches" value="'.$width.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Content</label>
                                                            <input type="text" class="form-control" name="content" id="exampleFormControlInput2" placeholder="100% Viscose" value="'.$content.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Design No</label>
                                                            <input type="text" class="form-control" name="design_no" id="exampleFormControlInput2" placeholder="4329320" value="'.$design_no.'">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Design NAme/Color</label>
                                                            <input type="text" class="form-control" name="design_name_color" id="exampleFormControlInput2" placeholder="Peach" value="'.$design_name_color.'">
                                                        </div>

                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlTextarea1">Weight/Feel</label>
                                                            <textarea class="form-control" name="weight_feel" id="exampleFormControlTextarea1" rows="5" placeholder="Lighyweight & semi Sheer/used for making dresses, skirts, kurti,sarrees, etc." value="'.$weight_feel.'"></textarea>
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="..." name="full_description">'.$full_description.'</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class=" mb-2">
                                                        ...
                                                        <input type="text" class="form-control" name="price" id="exampleFormControlInput2" placeholder="1470 per meter" value="'.$price.'">
                                                    </div>
...
$("#update_imp_fabrics").submit(function(e){
    e.preventDefault();  
    ...
    if(banner.files.length == 0 || banner.files.length > 4)
    {
     ...
     $.ajax({
                    ...
                    success : function(response){
                        ...
                        alert(response);
                        window.loaction.href= "http://localhost/Tecido/new-admin/imp_fabric.php";
                    }
