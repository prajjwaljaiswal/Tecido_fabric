                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Name of Person</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Ankit Saini" name="name"  required="required">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Name of Brand</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Tecido Fabrics" name="brand" required="required">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Email</label>
                                                            <input type="email" class="form-control" id="exampleFormControlInput2" placeholder="info@tecidofabrics.com" name="email"  required="required">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Ph. no.</label>
                                                            <input type="number" class="form-control" id="exampleFormControlInput2" placeholder="7889839939" name="number"  required="required">
                                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class="col-md-12 mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Vadodara" name="city"  required="required">
                                                    </div>
                                                    <div class="col-md-12 mb-4">
                                                        <label for="exampleFormControlTextarea1">Address</label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="address"  required="required"></textarea>
                                                    </div>
                                                    <div class="col-md-12 ">
                                                        <button class="btn btn-danger new-btn" type="submit" >Add This Customer</button>
                                                    </div>
