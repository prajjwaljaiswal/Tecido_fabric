                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled " id="dashboard" data-parent="#accordionExample">
                            <li  >
                                <a href="Sales.php"> New </a>
                            </li>
                            <li >
                                <a href="sales_Emp.php"> Existing </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div id="browser_default" class="col-lg-12 layout-spacing col-md-12">
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <form id="add_imp_fabrics">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Fabric name</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Georgette" name="fabric_name">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Weave</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Plain" name="weave">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Width</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="50 Inches" name="width">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Content</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="100% Viscose" name="content">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Design No</label>
                                                            <input type="number" class="form-control" id="exampleFormControlInput2" placeholder="4329320" name="design_no">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Design NAme/Color</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Peach" name="design_name_color">
                                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class=" mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="1470 per meter" name="price">
                                                    </div>
                                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                                        ...
                                                        <label class="custom-file-container__custom-file" >
                                                            <input type="file" id="files" name="upload[]" class="custom-file-container__custom-file__custom-file-input" multiple>
                                                ...
                                                <div class="col-md-12 " style="text-align: center;">
                                                    <button class="btn btn-danger new-btn" type="submit" >Add new Fabric</button>
