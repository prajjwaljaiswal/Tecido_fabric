                            ...
                            <div id="browser_default" class="col-lg-12 layout-spacing col-md-12">
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <form id="add_vel_fabrics">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-2">
                                                            <label for="exampleFormControlInput2">Fabric name</label>
                                                            <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Georgette" name="fabric_name" required>
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <input type="number" class="form-control" id="exampleFormControlInput2" placeholder="4329320" name="design_no" required>
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                ...
                                                <div class="col-md-7">
                                                    <div class=" mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="1470 per meter" name="price" required>
                                                    </div>
