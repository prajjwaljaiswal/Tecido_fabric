...
<!-- Mirrored from designreset.com/cork/ltr/demo4/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jul 2020 07:23:3
-->
<head>
    <meta charset="utf-8">
...
<body>
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><span>Dayeble Fabric </span></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>Existing </span></li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-one desk_flex" >
                                ...
                                <div class="inv-action">
                                    <a href="new_dae_fabric.php" class="btn btn-danger">Add New fabric</a>
                                </div> 
                        </div>
                    </div>
                                ...
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $query = $db->prepare("SELECT * FROM dayeble_fabric");
                                            $query->execute();
                                            ...
                                            <td style="color: black">'.$data['fabric_name'].'</td>
                                            <td>'.$data['weave'].'</td>
                                            <td>'.$data['design_name_color'].'</td>
                                            <td>'.$data['width'].'</td>
                                            <td>'.$data['price'].'</td>
                                            <td>';
                                
                                            echo $data['design_no'];
                                            // $string = $data['design_no'];
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">New or Existing customer</h5>
                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input type="number" class="form-control" id="exampleFormControlInput2" placeholder="7889839939" min="0000000000" max="9999999999" maxlength="10">
                                        </div>   
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">New iPhone Type</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </button>
                </div>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-row">
                                        <div class="col-md-12 mb-2">
                                            <label for="exampleFormControlInput2">Select iPhone </label>
                                            <select class="custom-select" id="exampleFormControlInput2" required>
                                                <option value="64 GB">select</option>
                                                <option value="64 GB">iPhone 12</option>
                                                <option value="64 GB">iPhone 11</option>
                                                <option value="64 GB">iPhone X</option>
                                                <option value="64 GB">iPhone XS</option>
                                                <option value="64 GB">iPhone XS Max</option>
                                                <option value="64 GB">iWatch 5</option>
                                                <option value="128 GB">Airpods Pro</option>
                                              </select>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <label for="exampleFormControlInput2">Select Storage </label>
                                            <select class="custom-select" id="exampleFormControlInput2" required>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input type="number" class="form-control" id="exampleFormControlInput2" placeholder="20,000" >
                                        </div>
...
<!-- Mirrored from designreset.com/cork/ltr/demo4/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jul 2020 07:23:37 GMT -->
</html>